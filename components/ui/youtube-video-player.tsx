            ...
            {!playing && (
              <>
                ...
                <motion.div
                  ...
                  className="absolute inset-0 bg-gradient-to-b from-zinc-900/0 to-black flex flex-col items-center justify-center z-10"
                >
                  <Button
                    size="lg"
                    variant="ghost"
                  ...
                  {title && (
                    <motion.h3
                      ...
                      className={cn(
                        "mt-4 max-w-xs text-center text-sm font-medium text-white md:max-w-md md:text-base",
                        titleClassName
                      )}
                    >
                      {title}
                ...
                >
                  {!playing && (
                    <>
                      ...
                      <motion.div
                        layoutId={`youtube-player-content-overlay-${videoId}`}
                        className="absolute inset-0 bg-gradient-to-b from-transparent to-black flex flex-col items-center justify-center z-10"
                      >
                        <Button
                          size="lg"
                          variant="ghost"
                        ...
                        {title && (
                          <motion.h3
                            layoutId={`youtube-player-title-${videoId}`}
                            className={cn(
                              "mt-10 max-w-xs text-center text-sm font-medium text-white md:max-w-md md:text-base",
                              titleClassName
                            )}
                          >
                            {title}
